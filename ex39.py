...
yanki = "США"
state = states.get(yanki)

if not state:
    print(f"Прошу прощения, ", yanki, "не существует или уничтожено.")

# получение города со значение по умолчанию
city = cities.get("США", 'не существует')
print(f"В стране", yanki, "есть город: ",city)
