def cheese_and_crackers(cheese_count, boxes_of_crackers):
    vsego_snekov=cheese_count+boxes_of_crackers
    print(f"У нас есть {cheese_count} сырков!")
    print(f"У нас есть {boxes_of_crackers} пачек чипсов!")
    print(f"Всего их {vsego_snekov}. Этого достаточно для вечеринки!")
    #print(f"Всего их {cheese_and_crackers}. Этого достаточно для вечеринки!")
    print("Погнали!\n")
...
print("Мы дажее можем выполнять вычисления внутри функции:")
