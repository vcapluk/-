...
print("Вы должны знать от управляющих последовательностях с символом \\, которые:")
...
start_point = 10000
beans, jars, crates = secret_formula(start_point) #здесь вместо jelly_beans и тд
                                                  # значение присваиваем beans и тд
...
print("Мы так же можем сделать это таким образом:")
